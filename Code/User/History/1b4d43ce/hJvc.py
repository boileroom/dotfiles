...
files = glob.glob("/data2/MPHY_Run43/902/Run43_0718_Sapphire902-ABCD_slot5_DG50_QET50pct_PTon_Noise/*.txt")

saveF = ROOT.TFile("Run43_0718_Sapphire902-ABCD_slot5_DG50_QET50pct_PTon_Noise.root","RECREATE")
cutoff=8000
